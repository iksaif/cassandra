...
public class CoalescingStrategiesTest
{
    ...
    {
        int oldValue = DatabaseDescriptor.getOtcCoalescingEnoughCoaslescedMessages();
        DatabaseDescriptor.setOtcCoalescingEnoughCoaslescedMessages(1);
        try {
            cs = newStrategy("FIXED", 200);
            ...
            DatabaseDescriptor.setOtcCoalescingEnoughCoaslescedMessages(oldValue);
        }
