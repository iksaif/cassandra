...
public class DatabaseDescriptor
{
    ...
    */
    ...
    public static int getOtcCoalescingEnoughCoaslescedMessages()
    {
        return conf.otc_coalescing_enough_coalesced_messages;
    }

    public static void setOtcCoalescingEnoughCoaslescedMessages(int otc_coalescing_enough_coalesced_messages)
    {
